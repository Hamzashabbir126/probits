...
export const PlatformPage = (): JSX.Element => {
  return (
    <div className="bg-white w-full overflow-x-hidden">
      {/* Hero Section */}
      <PageHeroSection 
        backgroundImage="https://c.animaapp.com/mf0ibufrGSDetp/img/zoshua-colah-dlopwy9jclm-unsplash-1.png"
        title="Tactical and strategic planning with asset-level clarity."
        highlightWords={["Tactical and strategic"]}
      />

      {/* Green Banner */}
      <div className="w-full bg-[#5da502] py-4 px-4 md:px-8">
